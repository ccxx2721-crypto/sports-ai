...
for _, row in df.iterrows():
    ...
    p_home_cover = 1 - norm.cdf(spread, loc=mu, scale=SIGMA)
    p_away_cover = 1 - p_home_cover

    ev_home = p_home_cover * PAYOUT - (1 - p_home_cover)
    ev_away = p_away_cover * PAYOUT - (1 - p_away_cover)
